...
const timelineData = [
  {
    ...
    content: (
      <div>
        <p className="text-white opacity-80 text-xs md:text-sm font-normal mb-2">
        ...
        <div className="grid grid-cols-1 gap-4">
          <Card className="glass-panel p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white opacity-70">10 minutes of focused breathing</p>
            </div>
          </Card>
          <Card className="glass-panel p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white opacity-70">Discussed stress management techniques</p>
            </div>
          </Card>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-4">
          <Card className="glass-panel p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white opacity-70">3 things you were grateful for</p>
            </div>
          </Card>
          <Card className="glass-panel p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white opacity-70">15 minutes before sleep</p>
            </div>
          </Card>
        </div>
      </div>
